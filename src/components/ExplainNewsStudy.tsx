...
const ExplainNewsStudy = () => {
  return (
    <div className="flex justify-center items-center h-[900px]">
        <div>
            <img className="w-[800px] mr-20 rounded-xl shadow-xl" src="https://images.pexels.com/photos/20705274/pexels-photo-20705274/free-photo-of-hand-holding-newspapers-in-darkness.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"/>
        </div>
