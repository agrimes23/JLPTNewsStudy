    ...
    <main className="flex flex-col min-w-screen min-h-screen">
        ...
        <div>
            <div className="relative flex min-w-screen h-full">
                ...
                <div className="absolute w-[80vw] lg:w-[500px]  bg-black rounded-2xl bg-opacity-60 right-[8%] top-[35%] p-10 md:p-20">
                    <h2 className="text-white text-[25px] md:text-[40px] text-center">
                        Learn how to read kanji from Japanese news
                    </h2>
                    <h3 className="text-white text-[20px] md:text-[25px] text-center mt-5">
                        <p>日本のニューズで</p>
                        <p>漢字の読む方を学ぶ</p>
                    </h3>
